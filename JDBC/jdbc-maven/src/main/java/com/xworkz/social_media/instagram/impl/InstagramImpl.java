package com.xworkz.social_media.instagram.impl;

import com.xworkz.social_media.dto.InstaUsersDto;
import com.xworkz.social_media.instagram.Instagram;
...
//startswith s and ends with  a and cvv starts with 2
    public List<InstaUsersDto> getAllUsersStartsWithSAndEndsWithA(){
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        List<InstaUsersDto> dtos = new ArrayList<>();
        try {
            con = DriverManager.getConnection("jdbc:mysql://127.0.0.7:3306/social_media","root","Xworkzodc@123");
            stmt = con.prepareStatement("select * from instagram_profiles where user_name like 's%n' and phone_no like '4%'");
            rs = stmt.executeQuery();
            while (rs.next()){
                InstaUsersDto dto = new InstaUsersDto();
                dto.setId(rs.getInt(1));
    ...
    public List<InstaUsersDto> getAllUsersDataStartsWith4ForPhoneNo(){
        Connection con = null;
        PreparedStatement stmt = null;
        ResultSet rs = null;
        List<InstaUsersDto> instaUsersDtos = new ArrayList<>();
        try {
            con = DriverManager.getConnection("jdbc:mysql://127.0.0.7:3306/social_media","root","Xworkzodc@123");
            stmt = con.prepareStatement("select * from instagram_profiles where phone_no like '4%'");
            rs = stmt.executeQuery();
    ...
    public boolean sqlToExcel(){
        try{
            String filename="C:\\Users\\ullas\\Desktop\\instagram.xls" ;

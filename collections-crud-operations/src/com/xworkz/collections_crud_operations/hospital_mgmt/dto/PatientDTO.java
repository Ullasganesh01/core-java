package com.xworkz.collections_crud_operations.hospital_mgmt.dto;
...
// to sort data
    @Override
    public int compareTo(PatientDTO o) { // compareTo(comparable) to used mainly for sorting ID's // compare(Comparator) is used to sort based on other columns
        return this.patientId - o.patientId; //ascending sort
        //return  o.patientId - this.patientId;//descending sort
        //return check(this.patientName) - check(o.patientName);//asc
        //return check(o.patientName) - check(this.patientName); //desc
        //return this.patientName.compareTo(o.patientName); // asc
        //return this.address.compareTo(o.address);//asc
    }
}

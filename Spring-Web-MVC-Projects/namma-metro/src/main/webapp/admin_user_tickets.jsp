        ...
        <nav class="navbar navbar-expand-lg bg-info-subtle text-primary-emphasis p-3">
            ...
            <c:choose>
              <c:when test="${not empty sessionScope.sessionId && not empty sessionScope.admin && sessionScope.sessionId == sessionScope.admin}">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="./ticket_list.jsp"><button type="button" 
              ...
              <c:otherwise>
                ...
                <li class="nav-item">
                    ...
                    <form class="d-flex mysearchform" action="filterTickets">
            ...
            <thead class="table-success">
                <tr class="bg-danger">
                    ...
                    <th scope="col">User ID
                        <!-- <span class="sort-icons"><a href="sortTickets?sortBy=userIdAsc"><i class="fa-solid fa-sort-up"></i></a>
                        <a href="sortTickets?sortBy=userIdDesc"><i class="fa-solid fa-sort-down"></i></a></span> -->
                    </th>
                </tr>
            </thead>
            <tbody>

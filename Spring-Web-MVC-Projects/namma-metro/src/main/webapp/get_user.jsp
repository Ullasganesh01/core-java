      ...
      <div class="content">
        <form action="updateUser" method="post" onsubmit="return validateForm()">
          <div class="user-details">
            <input type="text" name="uid" id="id" value="${user.getUid()}" style="display : none">
            <div class="input-box">
              <span class="details">Full Name</span>
              <input type="text" placeholder="Enter your name" id="name" name="name" value="${user.getName()}" onblur="validateName()">
              <br><span id="name-error" class="error"></span>
            </div>
            <div class="input-box">
              <span class="details">Email</span>
              <input type="text" placeholder="Enter your email" id="email" name="email" value="${user.getEmail()}" onblur="validateEmail()">
              <br><span id="email-error" class="error"></span>
            </div>
            <div class="input-box">
              <span class="details">Phone Number</span>
              <input type="text" placeholder="Enter your phone number" id="contactno" name="contactNo" value="${user.getContactNo()}"
                onblur="validateContactNo()">
              <br><span id="contact-error" class="error"></span>
            </div>
            <div class="input-box">
              <span class="details">Address</span>
              <input type="text" placeholder="Enter your address" id="address" name="address" value="${user.getAddress()}"
                onblur="validateAddress()">
              <br><span id="address-error" class="error"></span>
            </div>
            <div class="input-box" style="display: none;">
              <span class="details">Password</span>
              <input type="password" placeholder="Enter your password" id="password" name="password" value="${user.getPassword()}"
                onblur="validatePassword()">
              <br><span id="password-error" class="error"></span>
            </div>
            <div class="input-box" style="display: none;">
              <span class="details">Confirm Password</span>
              <input type="password" placeholder="Confirm your password" id="confirmPwd" name="confirmPwd" value="${user.getPassword()}"

...
document.getElementById("time").innerHTML = date.join("/");
...
function validateComments(){
    ...
    if(comments ===" " || comments.length<25){
        commentsErr.innerHTML = "Comment cannot be empty <br> Minimum 25 characters ";
...
function validateForm(){
    if(validateName() && validateEmail() && validateContactNo() && validateComments()){
        return true;
    }
    else{
        return false;
